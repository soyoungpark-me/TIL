...
public class MultiChatController implements Runnable{
    ...
    public void run() {
        ...
        while(status) {
            try {
                // 메시지 수신 및 파싱
                String input;
                while ((input = inMsg.readLine()) != null) {
                    msgContents.append(input);
                }

                String msg = msgContents.toString();

                if (msgContents != null && msg != "") {
    ...
    public static void main(String[] args) {
        ...
        MultiChatController multiChatController =
                new MultiChatController(
                        new MultiChatData(),
                        new MultiChatUI()
                );
